...
# $ C:\Users\afikm\Downloads\programs\opencv\opencv\build\x64\vc15\bin\opencv_annotation.exe --annotations=pos.txt --images=positive/
...
# C:\Users\afikm\Downloads\programs\opencv\opencv\build\x64\vc15\bin\opencv_createsamples.exe -info pos.txt -w 24 -h 24 -num 1000 -vec pos.vec
...
# C:\Users\afikm\Downloads\programs\opencv\opencv\build\x64\vc15\bin\opencv_traincascade.exe -data cascade/ -vec pos.vec -bg neg.txt -precalcValBufSize 30000 -precalcIdxBufSize 30000 -numPos 300 -numNeg 1000 -numStages 16 -w 24 -h 24 -maxFalseAlarmRate 0.4 -minHitRate 0.999